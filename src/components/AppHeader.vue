    ...
    <div class="header-inner">
      <div class="header-left">
        <template v-if="isBoard && activeProject">
          <router-link to="/projects" class="breadcrumb-link">{{ t('projects') }}</router-link>
      ...
      <div class="header-right">
        <button class="theme-btn" @click="toggleTheme" :title="ui.lightMode ? t('switchToDark') : t('switchToLight')">
