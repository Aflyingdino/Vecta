  ...
  >
    ...
    <div class="task-top">
      ...
      <div class="task-menu-wrap">
        <button class="task-menu-btn" @click.stop="toggleMenu" aria-label="Taakopties">
      ...
      <template v-if="menuOpen">
        ...
        <div class="task-dropdown" :style="{ top: dropdownPos.top + 'px', right: dropdownPos.right + 'px' }">
          ...
          <div class="dd-divider"></div>
                    <button class="dd-item" @click.stop="emit('archive', task.id); closeMenu()" title="Archive task">
                      <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
