    ...
    <div class="card-body">
      <div class="card-top">
        ...
        <button
          ...
          :title="isProjectMuted ? 'Meldingen inschakelen' : 'Meldingen dempen'"
        >
      ...
      <p class="card-desc">{{ project.description || 'Geen beschrijving' }}</p>
      ...
      <div class="card-stats">
        <span class="stat">
          ...
          {{ totalTasks }} taak{{ totalTasks !== 1 ? 'en' : '' }}
        </span>
        <span class="stat">
          <svg width="12" height="12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
          {{ project.members.length }} lid{{ project.members.length !== 1 ? 'en' : '' }}
        </span>
      </div>
      ...
      <div class="card-progress" v-if="totalTasks > 0">
        ...
        <span class="progress-label">{{ progress }}% klaar</span>
      </div>
    </div>
  </router-link>
</template>
